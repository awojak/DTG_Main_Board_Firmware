...
#define GCONF 0x00
	#define	GCONF_I_SCALE_ANALOG 0x01
	#define GCONF_INTERNAL_RSENSE 0x02
	#define GCONF_EN_SPREAD_CYCLE 0x04
	#define GCONF_SHAFT 0x08
	#define GCONF_INDEX_OTPW 0x10
	#define GCONF_INDEX_STEP 0x20
	#define GCONF_PDN_DISABLE 0x40
	#define GCONF_MSTEP_REG_SELECT 0x80
	#define GCONF_MULTISTEP_FILT 0x100
	#define GCONF_TEST_MODE 0x200

/* [R+WC] GSTAT - Global status flag */
#define GSTAT 0x01
	#define GSTAT_RESET 0x01
