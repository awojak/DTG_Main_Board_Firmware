...
int main(void)
{
  ...
  main_threadHandle = osThreadNew(mainThread, NULL, &main_thread_attributes);
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pins : LCD_RS_Pin LED_STATUS_Pin OPC1_SIGNAL_Pin */
  GPIO_InitStruct.Pin = LCD_RS_Pin|LED_STATUS_Pin|OPC1_SIGNAL_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  /*Configure GPIO pin : PHOTO_SENSOR_Pin */
  GPIO_InitStruct.Pin = PHOTO_SENSOR_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(PHOTO_SENSOR_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pins : TABLE_SENSOR_Pin INPUT3_Pin */
  GPIO_InitStruct.Pin = TABLE_SENSOR_Pin|INPUT3_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOE, &GPIO_InitStruct);
  ...
  /*Configure GPIO pins : OUTPUT2_Pin EEPROM_P_Pin Z_ENABLE_Pin Y_ENABLE_Pin */
  GPIO_InitStruct.Pin = OUTPUT2_Pin|EEPROM_P_Pin|Z_ENABLE_Pin|Y_ENABLE_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOD, &GPIO_InitStruct);

  /*Configure GPIO pin : LIMIT_Y_BACK_Pin */
  GPIO_InitStruct.Pin = LIMIT_Y_BACK_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
