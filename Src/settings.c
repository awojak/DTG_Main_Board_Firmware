...
//Testowe tablice
uint8_t settingNamesWords[] = { 'a', 'b'};
uint8_t wordSymbols[] = { 'a','b','c'};
setting_t settingsTable[5];
uint8_t settingsPgnCounts[5];
pgn_t settingsPgn[5];
setting_min_t settingMinMaxTable[5];
#define SETTING_INDEXES_GET_MIN(val) 0
#define SETTING_INDEXES_GET_MAX(val) 0
lookupTableEntry_t settingLookupTables[5];
#define LOOKUP_TABLE_COUNT 5

const pgRegistry_t __pg_registry_start[5];
const pgRegistry_t __pg_registry_end[5];
